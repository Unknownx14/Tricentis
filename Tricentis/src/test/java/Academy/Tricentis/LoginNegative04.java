...
public class LoginNegative04 extends BaseTest03 {
	...
	public void loginWrongCredentials(HashMap<String, String> input) throws InterruptedException, IOException
	{
		...
		String username = input.get("emailJson");
		String password = input.get("passwordJson");
		String errorMessageExpected = input.get("errorMessageJson");
	...
	/*	HashMap<String, String> hmap01 = new HashMap<String, String>();
		...
		*/
		...
		List<HashMap<String, String>> data =  getJsonDataToHashMap(System.getProperty("user.dir") + "\\src\\test\\java\\Academy\\data\\LoginScenarios.json");
